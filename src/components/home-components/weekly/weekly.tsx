    ...
    <section className="mt-[80px] mb-[66px]">
      <div className="my-con">
        <div className="flex gap-14">
          <div className="left">
            <div>
              <div className="top-left flex items-center w-[880px] relative left-0 h-[40px]">
                <RhombButton
                  children="Weekly Best News"
                  height="h-[40px]"
                  width="w-[226px]"
                />
                <div className="border-[1px] border-[rgba(223,_223,_223,_1)] w-[671px] h-[5px] absolute left-[200px]"></div>
              </div>
            </div>
          ...
          <div className="right">
            <div>
              <div className="top-left flex items-center relative left-0 h-[40px]">
                <RhombButton
                  children="Hot News"
                  height="h-[40px]"
                  width="w-[145px]"
                />
                <div className="border-[1px] border-[rgba(223,_223,_223,_1)] w-[195px] h-[5px] absolute left-[135px]"></div>
              </div>
            </div>
